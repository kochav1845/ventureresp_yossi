CREATE OR REPLACE FUNCTION public.get_single_customer_timeline(p_customer_id text, p_date_from date DEFAULT NULL::date, p_date_to date DEFAULT NULL::date, p_grouping text DEFAULT 'day'::text)
 RETURNS TABLE(date text, balance numeric, invoices numeric, payments numeric, overdue_90_days numeric)
 LANGUAGE plpgsql
 SECURITY DEFINER
