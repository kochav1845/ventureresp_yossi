...
export default function MonthSummaryCards({ months }: MonthSummaryCardsProps) {
  ...
  const cards = [
    ...
    { label: 'Credit Memos', amount: totals.creditMemos, count: totals.creditMemoCount, icon: FileText, gradient: 'from-violet-500 to-violet-600', description: 'Credit memo adjustments' },
