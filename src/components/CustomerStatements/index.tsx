  ...
  return (
    <div className="max-w-7xl mx-auto flex flex-col h-[calc(100vh-8rem)] gap-4">
      ...
      <div className="flex-1 grid grid-cols-1 xl:grid-cols-3 gap-6 min-h-0">
        <div className="xl:col-span-2 flex flex-col min-h-0 gap-3">
      ...
      <div data-tour="statement-actions" className="shrink-0">
        <StatementActions
      ...
      <div className="flex-1 overflow-y-auto rounded-xl border border-gray-200 bg-white divide-y divide-gray-100 min-h-0" data-tour="statement-list">
        ...
        <div className="xl:col-span-1 flex flex-col min-h-0 gap-4 overflow-y-auto pr-0.5">
          <div className="bg-white rounded-xl border border-gray-200 p-4 shrink-0 space-y-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="relative flex-1">
                ...
                <input
                  ...
                  placeholder="0"
                  className="w-full pl-8 pr-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-800 focus:ring-2 focus:ring-blue-400 focus:border-transparent"
                />
              </div>
            </div>
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="flex-1 px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-700 focus:ring-2 focus:ring-blue-400"
              >
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    placeholder="0"
                    className="w-full pl-8 pr-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-800 focus:ring-2 focus:ring-blue-400 disabled:opacity-50"
                  />
                </div>
              </div>
            </div>
