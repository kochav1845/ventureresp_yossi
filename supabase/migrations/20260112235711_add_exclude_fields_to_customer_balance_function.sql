/*
  # Add Exclusion Fields to Customer Balance Function

  1. Changes
    - Add exclude_from_payment_analytics and exclude_from_customer_analytics to the return type
    - Add these fields to all SELECT statements in the function
    - Enables UI to display and manage customer exclusions from analytics

  2. Fields Added
    - exclude_from_payment_analytics: BOOLEAN - Exclude customer from payment analytics
    - exclude_from_customer_analytics: BOOLEAN - Exclude customer from customer analytics
*/
