/*
  # Add Average Days to Collect to Customer Balance Function

  1. Changes
    - Drop and recreate get_customers_with_balance function
    - Add avg_days_to_collect column to return type
    - Calculate average days from invoice date to payment date for each customer
    - Uses payment_invoice_applications to link invoices and payments
    - Add sorting support for avg_days_to_collect

  2. Logic
    - Joins payment applications with invoices and payments
    - Excludes credit memos and prepayments
    - Calculates average collection time across all applications
