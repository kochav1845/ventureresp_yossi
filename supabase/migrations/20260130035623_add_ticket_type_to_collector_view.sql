/*
  # Add Ticket Type to Collector View

  1. Changes
    - Add ticket_type column to collector_assignment_details view
    
  2. Notes
    - This allows collectors to see the type of ticket (overdue payment, partial payment, etc.)
*/

-- Drop the existing view
DROP VIEW IF EXISTS collector_assignment_details;

-- Recreate the view with ticket_type
