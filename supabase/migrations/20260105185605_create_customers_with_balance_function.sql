/*
  # Create function to get customers with calculated balances

  1. New Function
    - `get_customers_with_balance` - Returns all customers with pre-calculated balance and invoice counts
    - Performs aggregation at database level for efficiency
    - Supports sorting by any column including calculated fields
    - Supports search filtering
    - Supports pagination

  2. Performance
    - Uses single query with LEFT JOIN and GROUP BY
