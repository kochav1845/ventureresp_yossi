/*
  # Fix get_payments_with_applications return type

  1. Changes
    - Changed `id` return column from `integer` to `uuid` to match the actual
      `acumatica_payments.id` column type.

  2. Notes
    - The previous migration introduced a type mismatch causing a 400 error
