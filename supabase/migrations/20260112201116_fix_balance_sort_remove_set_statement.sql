/*
  # Fix Balance Sort - Remove SET Statement

  1. Problem
    - SET LOCAL not allowed in STABLE functions
    - Causes "SET is not allowed in a non-volatile function" error
    
  2. Solution
    - Remove the SET statement
    - Rely on indexes for performance instead of timeouts
*/

-- Update search function without SET statement
