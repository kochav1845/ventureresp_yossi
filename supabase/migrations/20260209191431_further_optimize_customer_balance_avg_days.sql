/*
  # Further Optimize Customer Balance Function - Avg Days Calculation
  
  This migration further optimizes the get_customers_with_balance function by pre-computing
  avg_days_to_collect in a CTE instead of using a correlated subquery per row.
  
  ## Changes
  
  1. Pre-compute avg_days_to_collect in a CTE
  2. Use LEFT JOIN instead of correlated subquery
  3. This avoids running the expensive calculation for each row individually
*/
