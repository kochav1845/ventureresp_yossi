/*
  # Update Collector View to Filter Active Tickets

  1. Changes
    - Update `collector_assignment_details` view to only show assignments with active tickets
    - This ensures inactive tickets never appear in the collector's assignment view
*/
