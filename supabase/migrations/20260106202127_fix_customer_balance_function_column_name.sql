/*
  # Fix Customer Balance Function Column Name

  1. Changes
    - Fix `get_customers_with_balance` to use `i.customer` instead of `i.customer_id`
    - Fix `get_customers_with_balance_count` to use `i.customer` instead of `i.customer_id`
    - The acumatica_invoices table uses `customer` column, not `customer_id`

  2. Impact
    - Resolves "column i.customer_id does not exist" error
    - Customers page will load correctly
*/
