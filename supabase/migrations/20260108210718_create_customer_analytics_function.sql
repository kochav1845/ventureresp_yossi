/*
  # Create Customer Analytics Function
  
  1. Purpose
    - Returns aggregate analytics for ALL customers in the database
    - Respects search and filter parameters
    - Used for real-time analytics dashboard
  
  2. Returns
    - total_customers: Total count of customers matching filters
    - active_customers: Count of active customers
    - total_balance: Sum of all customer balances
    - avg_balance: Average balance for customers with debt
    - customers_with_debt: Count of customers with positive balance
    - total_open_invoices: Sum of all open invoices
    - customers_with_overdue: Count of customers with overdue invoices
  
  3. Parameters
    - p_search: Optional search term for filtering
    - p_status_filter: Filter by customer status (Active, Inactive, Hold, or 'all')
    - p_country_filter: Filter by country or 'all'
    - p_date_from: Optional start date for invoice filter
    - p_date_to: Optional end date for invoice filter
*/
