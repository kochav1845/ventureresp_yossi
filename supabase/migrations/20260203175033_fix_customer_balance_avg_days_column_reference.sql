/*
  # Fix Column Reference in get_customers_with_balance Function

  1. Issue
    - The customer_avg_collection_days CTE references i.customer_id which doesn't exist
    - acumatica_invoices table has 'customer' column, not 'customer_id'
    - acumatica_payments table has 'customer_id' column

  2. Fix
    - Change i.customer_id to p.customer_id in the CTE
    - This matches the payments table schema and the JOIN on line 161
*/
