/*
  # Add Days Overdue Filter to Customer Functions

  1. Purpose
    - Add p_min_days_overdue and p_max_days_overdue parameters
    - Enable filtering customers by max days overdue range
    - Support quick filters with days overdue criteria

  2. Changes to get_customers_with_balance
    - Add p_min_days_overdue INT parameter
    - Add p_max_days_overdue INT parameter
    - Add WHERE clause filtering based on max_overdue_days

  3. Changes to get_customers_with_balance_count
    - Add p_min_days_overdue INT parameter
    - Add p_max_days_overdue INT parameter
    - Ensure count matches the main function's filtering
*/

-- Drop and recreate get_customers_with_balance with new parameters
...
-- Update get_customers_with_balance_count to match
