/*
  # Fix Collection Ticket Activity Logging
  
  This migration fixes the collection ticket activity logging trigger to use the correct column name.
  
  ## Changes
  
  - Replace all references to `assigned_to` with `assigned_collector_id` in the log_collection_ticket_activity trigger function
*/
