/*
  # Fix Customer Analytics Function - Use Correct Column Names
  
  1. Correct Column Mappings
    - Join: customers.customer_id = invoices.customer
    - Invoice status: status (not invoice_status)
    - Invoice date: date (not invoice_date)
