/*
  # Fix Invoice Search Count - Remove SHOW Command

  1. Problem
    - SHOW statement_timeout is not allowed in STABLE functions
    
  2. Solution
    - Remove SHOW command
    - Just set LOCAL statement_timeout directly
    - Simplify the function
*/

-- Drop and recreate without SHOW command
