/*
  # Add Credit Memo Handling to Customer Balance Calculation

  1. Changes
    - Update get_customers_with_balance function to properly handle credit memos
    - Add p_exclude_credit_memos parameter to control whether to deduct credit memos
    - Calculate three types of balances:
      - Gross balance: Sum of regular invoices only
      - Credit memo balance: Sum of credit memos and credit write-offs
      - Net balance: Gross balance minus credit memos
    - Return appropriate balance based on parameter

  2. Notes
    - Credit memos have negative impact on what customers owe
    - By default, balance should include credit memo deductions (net balance)
    - Checkbox allows viewing gross balance without credit memo deductions
*/
