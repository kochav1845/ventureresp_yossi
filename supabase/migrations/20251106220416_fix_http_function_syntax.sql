/*
  ...
  ## Overview
  Updates the invoke_email_scheduler function to use correct http extension syntax.

  ## Changes
  - Use proper http() function with http_request type
  - Fix function call syntax
*/

-- Update the function with correct http extension syntax
...
BEGIN
  ...
  BEGIN
    -- Make HTTP POST request using the http extension
    request_result := http(
      (
        'POST',
