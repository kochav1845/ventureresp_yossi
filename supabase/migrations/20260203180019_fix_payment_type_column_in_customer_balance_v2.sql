/*
  # Fix Payment Type Column in get_customers_with_balance Function

  1. Issue
    - The customer_avg_collection_days CTE references p.doc_type which doesn't exist
    - acumatica_payments table has 'type' column, not 'doc_type'

  2. Fix
    - Change p.doc_type to p.type in the WHERE clause
*/
