/*
  # Update Collector Assignment Details View to Include Ticket Assignment Info

  1. Changes
    - Add ticket assigned_at and assigned_by columns to the view
    - Add ticket assigner email to the view
  
  2. Notes
    - This will show both invoice assignment info and ticket assignment info
*/

-- Drop the existing view
DROP VIEW IF EXISTS collector_assignment_details;

-- Recreate the view with ticket assignment information
