/*
  # Add Red Threshold Days Sorting Support

  1. Changes
    - Add sorting logic for red_threshold_days in get_customers_with_balance function
    - Enables users to sort customers by their custom red status threshold

  2. Purpose
    - Allow sorting by the days_past_due_threshold column (returned as red_threshold_days)
    - Makes it easier to find customers with custom threshold settings
*/
