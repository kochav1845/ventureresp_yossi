/*
  # Fix column reference in get_filtered_invoice_aggregates

  1. Changes
    - Replace `i.doc_date` with `i.date` (the actual column name in acumatica_invoices)

  2. Notes
    - The function was referencing a non-existent `doc_date` column
    - The correct column is `date`
*/
