/*
  # Fix get_customers_with_balance Function Overload Issue

  1. Problem
    - Multiple function signatures exist causing ambiguous function resolution

  2. Solution
    - Drop all existing versions of the function
    - Create a single unified version with all parameters
*/

-- Drop all existing overloaded versions
DROP FUNCTION IF EXISTS get_customers_with_balance(TEXT, TEXT, TEXT, TEXT, TEXT, INT, INT);
DROP FUNCTION IF EXISTS get_customers_with_balance(TEXT, TEXT, TEXT, TEXT, TEXT, INT, INT, TIMESTAMP);
