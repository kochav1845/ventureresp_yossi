/*
  # Fix Column Name in get_customers_with_balance Function

  1. Changes
    - Fix reference to red_threshold_days column
    - Change from c.days_past_due_threshold to c.days_from_invoice_threshold
    - This is the correct column name in acumatica_customers table

  2. Details
    - The column was incorrectly referenced as days_past_due_threshold
    - Actual column name is days_from_invoice_threshold
