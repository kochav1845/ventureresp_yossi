/*
  # Add Max Days Overdue to Customer Balance Function

  1. Changes
    - Adds `max_days_overdue` field to the get_customers_with_balance function
    - This field shows the maximum number of days overdue for any unpaid invoice
    - Used to highlight customers with invoices over 90 days unpaid

  2. Purpose
    - Enable visual highlighting of customers with severely overdue invoices
    - Help collectors prioritize customers with long-outstanding balances
*/

DROP FUNCTION IF EXISTS get_customers_with_balance(TEXT, TEXT, TEXT, TEXT, TEXT, INT, INT, TIMESTAMP, TIMESTAMP);
