...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const url = `${acumaticaUrl}/entity/Default/24.200.001/Invoice?$top=${limit}&$orderby=Date desc&$select=ReferenceNbr,Date,Status,Amount,Balance,Customer`;

    console.log('Fetching recent invoices:', url);
